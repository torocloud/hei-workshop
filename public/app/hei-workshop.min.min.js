...
(function () {
  ...
  BlogCtrl.$inject = ['$scope', '$location', '$routeParams', 'api'];
...
function ApiFactory($rootScope, $http, $q, $location, $localStorage) {
  var api = this;
  var baseurl = document.querySelector('body[data-endpoint]').getAttribute('data-firebase');
...
//# sourceMappingURL=hei-workshop.min.min.js.map
